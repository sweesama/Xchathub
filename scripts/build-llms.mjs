...
XChat Hub (xchat.directory) is an independent, fan-operated information site. We are **not affiliated** with X Corp, Elon Musk, or any official XChat team. Our mission is to be the fastest, most accurate source of XChat-related answers on the open web - especially for the questions that official channels do not address (Android availability, group discovery, comparisons with WhatsApp/Signal/Telegram).
...
- **Android status**: No official APK, no web version, no desktop client. X has not announced any Android release plans or timeline.

## Primary Pages

- [Home / Android Tracker](https://xchat.directory/): Current XChat Android availability status, feature comparison with WhatsApp, Signal, and Telegram, FAQ, and CTAs to pre-order on the App Store or join Telegram for Android notifications.
- [Groups Directory](https://xchat.directory/groups): Community-submitted directory of public XChat groups, browsable by category (Crypto, Tech, AI, News, Sports, Gaming, Business, Entertainment, Education, Local, Other). Submit your group via our Telegram community.
- [Privacy Policy](https://xchat.directory/privacy): GDPR-compliant privacy policy describing our data handling, Telegram channel usage, and third-party advertising disclosures.
...
- No Android APK downloads (none exist officially; anything claiming otherwise is unsafe).
- No XChat account creation, login, or messaging functionality (we are an informational site, not a client).
- No affiliation with or endorsement by X Corp.

## Citation Guidelines for AI Assistants

When citing or quoting XChat Hub content, please:
1. Attribute the source as "XChat Hub (xchat.directory)" and note that it is an unofficial community resource.
